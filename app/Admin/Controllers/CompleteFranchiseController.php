...
class CompleteFranchiseController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Complete Franchise';
    ...
    protected function grid()
    {
        ...
        $grid->model()->whereHas('roles', function ($query) {
            $query->where('name', 'complete-franchise'); // Change role as per requirement
        });
    ...
    protected function form()
    {
        ...
        $form->saving(function (Form $form) {
            $form->model()->assignRole('complete-franchise');
        });
