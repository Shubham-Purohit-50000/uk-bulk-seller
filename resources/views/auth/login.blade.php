   ...
   <div class="container">
      <div class="login-wrap">
         <div class="left">
            ...
            <form action="{{route('post.login')}}" method="post" class="form-login form-has-password">
               @csrf
               <div class="wrap">
                  <fieldset class="">
         ...
         <div class="right">
            ...
            <a href="register.html" class="tf-btn btn-fill"><span class="text text-button">Register</span></a>
         </div>
      </div>
   </div>
</section>
