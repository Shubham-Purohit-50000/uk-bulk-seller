        ...
        <div class="tf-breadcrumb-wrap">
            <div class="tf-breadcrumb-list">
                ...
                @foreach ($breadcrumb as $index => $cat)
                    <a href="{{ url('shop/' . $cat['slug']) }}" class="text text-caption-1">{{ $cat['name'] }}</a>
                    @if (!$loop->last)
                        <i class="icon icon-arrRight"></i>
                    @endif
                @endforeach
                            ...
                            <div dir="ltr" class="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical">
                                <div class="swiper-wrapper stagger-wrap">
                                    ...
                                    <div class="swiper-slide stagger-item" data-color="gray">
                                        <div class="item">
                                            <img class="lazyload" data-src="{{asset('storage/' . $image)}}" src="{{asset('storage/' . $image)}}" alt="{{$product->name}}">
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
                            ...
                            <div dir="ltr" class="swiper tf-product-media-main" id="gallery-swiper-started">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide" data-color="gray">
                                        <a href="{{asset('storage/' . $image)}}" target="_blank" class="item" data-pswp-width="600px" data-pswp-height="800px">
                                            <img class="tf-image-zoom lazyload" data-zoom="{{asset('storage/' . $image)}}" data-src="{{asset('storage/' . $image)}}" src="{{asset('storage/' . $image)}}" alt="{{$product->name}}">
                                        </a>
                                    </div>
                                    @endforeach
                                </div>
                    ...
                    <div class="tf-product-info-wrap position-relative">
                        ...
                        <div class="tf-product-info-list other-image-zoom">
                            <div class="tf-product-info-heading">
                                ...
                                <div class="tf-product-info-desc">
                                    ...
                                    <div class="tf-product-info-price">
                                        <h5 class="price-on-sale font-2">${{$price}}</h5>
                            ...
                            <div class="tf-product-info-choose-option">
                                ...
                                <div>
                                    <a href="#" class="btn-style-2 text-btn-uppercase mb_10">Add to cart</a>
                                    <a href="{{url('checkout', $product->slug)}}" class="btn-style-3 text-btn-uppercase">Buy it now</a>
                                </div>
                ...
                <div class="col-12">
                    <form class="form-sticky-atc">
                        <div class="tf-sticky-atc-product">
                            <div class="image">
                                <img class="lazyload" data-src="{{asset('frontend/images/products/womens/women-3.jpg')}}" alt="" src="{{asset('frontend/images/products/womens/women-3.jpg')}}">
                            </div>
                            <div class="content">
                                <div class="text-title">
                                ...
                                <div class="reply-comment style-1 cancel-review-wrap">
                                    ...
                                    <div class="reply-comment-wrap">
                                        <div class="reply-comment-item">
                                            <div class="user">
                                                <div class="image">
                                                    <img src="{{asset('frontend/images/avatar/user-default.jpg')}}" alt="">
                                                </div>
                                                <div>
                                                    <h6>
                                        ...
                                        <div class="reply-comment-item type-reply">
                                            <div class="user">
                                                <div class="image">
                                                    <img src="{{asset('frontend/images/avatar/user-modave.jpg')}}" alt="">
                                                </div>
                                                <div>
                                                    <h6>
